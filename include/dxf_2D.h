...
class point
{
  public:
    ...
    double  xCo, 	         /**< x-coordinate of point(x, y, z) */
        ...
        /// Parameterised constructor. Default value of z is set to 0.	
...
class dxf :  public base
{
  public:
	    ...
	    /// Circle entity
		    void write_Circle(double, double, double, double, 
                              string);
		...
		/// Rectangle (solid fill)  entity
		    void write_Rect(double,double,double,double,double,
